              ...
              return s(i.default.mark((function e() {
                ...
                return i.default.wrap((function(e) {
                  while (1) switch (e.prev = e.next) {
                    case 0:
                      return t.role = n.getStorageSync("role"), u = n.getStorageSync("nowTable"), e.next = 4, t.$api.session(u);
                    case 4:
                      r = e.sent, t.user = r.data, t.tableName = u, a = o.default.list(), t.menuList = a, t.menuList.forEach((function(n, e) {
                        t.role == n.roleName && n.frontMenu.forEach((function(n, e) {
                          n.child[0].buttons.indexOf("查看") > -1 && t.swiperMenuList.push(n)
                        }))
                      }));
                    case 10:
                    case "end":
              ...
              return s(i.default.mark((function t() {
                ...
                return i.default.wrap((function(t) {
                  while (1) switch (t.prev = t.next) {
                    case 0:
                      return t.next = 2, n.$api.recommend("sushegonggao", 1, 4);
                    case 2:
                      return o = t.sent, n.sushegonggaolist = o.data.list, t.next = 6, n.$api.recommend("shiwuzhaoling", 1, 4);
                    case 6:
                      return o = t.sent, n.shiwuzhaolinglist = o.data.list, t.next = 10, n.$api.recommend("xunwuqishi", 1, 4);
                    case 10:
                      o = t.sent, n.xunwuqishilist = o.data.list;
                    case 12:
                    case "end":
                      return t.stop()
                  }
          ...
          var n = this,
            ...
            e = (n._self._c, n.__map(n.menuList, (function(t, e) {
              var i = n.__get_orig(t),
                o = n.__map(t.frontMenu, (function(e, i) {
                  var o = n.__get_orig(e),
                    u = n.role == t.roleName ? n.__map(e.child, (function(t, e) {
                      var i = n.__get_orig(t),
                        o = n.__map(t.buttons, (function(e, i) {
                          var o = n.__get_orig(e),
                            u = "查看" == e && "yifahuodingdan" != t.tableName && "yituikuandingdan" != t.tableName && "yiquxiaodingdan" != t.tableName && "weizhifudingdan" != t.tableName && "yizhifudingdan" != t.tableName && "yiwanchengdingdan" != t.tableName ? t.menu.split("列表") : null;
                          return {
                            $orig: o,
                            g0: u
                          }
            ...
            i = n.__map(n.sushegonggaolist, (function(t, e) {
              var i = n.__get_orig(t),
                o = t.fengmian ? t.fengmian.split(",") : null;
              return {
                $orig: i,
                g1: o
              }
            })),
            o = n.__map(n.shiwuzhaolinglist, (function(t, e) {
              var i = n.__get_orig(t),
                o = t.wupintupian ? t.wupintupian.split(",") : null;
              return {
                $orig: i,
                g2: o
              }
            })),
            u = n.__map(n.xunwuqishilist, (function(t, e) {
              var i = n.__get_orig(t),
                o = t.wupintupian ? t.wupintupian.split(",") : null;
              return {
                $orig: i,
